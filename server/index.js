...
const requestPublicFinalUploadSignature = require('./pages/createEventDP/requestPublicFinalUploadSignature')
const savePublicFinalImage = require('./pages/createEventDP/savePublicFinalImage')
...
app.post('/createEventDP/public/:projectSlug/:accessKey/final-upload-signature', requestPublicFinalUploadSignature)
app.post('/createEventDP/public/:projectSlug/:accessKey/finalize', savePublicFinalImage)
app.post('/createEventDP/public/:slug/final-upload-signature', requestPublicFinalUploadSignature)
app.post('/createEventDP/public/:slug/finalize', savePublicFinalImage)
