...
const CanvasToolbar = ({
    ...
    const newLocal = 'absolute top-3 left-1/2 -translate-x-1/2 w-[calc(100%-0.75rem)] sm:w-auto max-w-155 flex items-center justify-start sm:justify-center gap-1.5 sm:gap-2 p-1.5 bg-white/85 backdrop-blur-md rounded-2xl border border-dusty-green/25 shadow-lg shadow-forest-green/15 z-30 animate-fade-in-up overflow-x-auto'
    return (
        <div className={newLocal}>
            <div className='flex items-center gap-1 border-r border-dusty-green/20 pr-1 mr-0.5 sm:mr-1 shrink-0'>
                ...
                >
                    <Icon icon='mdi:undo' width='16' height='16' className='sm:w-4.5 sm:h-4.5' />
                </button>
                <button
                    type='button'
                    onClick={onRedo}
                    ...
                    className='p-1.5 sm:p-2 min-h-9 min-w-9 text-dark-slate hover:bg-pale-sage rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed'
                >
                    <Icon icon='mdi:redo' width='16' height='16' className='sm:w-4.5 sm:h-4.5' />
                </button>
            </div>
            ...
            <div className='flex items-center gap-1 border-r border-dusty-green/20 pr-1 mr-0.5 sm:mr-1 shrink-0'>
                ...
                >
                    <Icon icon='mdi:magnify-plus-outline' width='16' height='16' className='sm:w-4.5 sm:h-4.5' />
                </button>
                ...
                <button
                    ...
                    className='p-1.5 sm:p-2 min-h-9 min-w-9 text-dark-slate hover:bg-pale-sage rounded-lg transition-colors'
                >
                    <Icon icon='mdi:magnify-minus-outline' width='16' height='16' className='sm:w-4.5 sm:h-4.5' />
                </button>
            </div>
            ...
            >
                <span className={`flex items-center gap-1 px-2 py-1.5 rounded-lg text-[10px] sm:text-[11px] font-bold tracking-wide uppercase transition-colors ${!previewMode
                    ...
                    : 'text-white/70'}`}>
                    <Icon icon='mdi:pencil-outline' width='14' height='14' className='sm:w-3.75 sm:h-3.75' />
                    Edit
                </span>
                <span className={`flex items-center gap-1 px-2 py-1.5 rounded-lg text-[10px] sm:text-[11px] font-bold tracking-wide uppercase transition-colors ${previewMode
                    ? 'bg-white text-dark-slate'
                    : 'text-dark-slate/65'}`}>
                    <Icon icon='mdi:eye-outline' width='14' height='14' className='sm:w-3.75 sm:h-3.75' />
                    Preview
                </span>
            </button>
        </div>
