        ...
        <nav className='h-16 px-4 sm:px-6 flex items-center justify-between bg-white border-b border-dusty-green/25 z-40 animate-fade-in'>
            ...
            <div className='flex items-center gap-3'>
                {showGenerateLink && (
                    <button
                        type='button'
                        className='px-4 py-2 rounded-xl bg-forest-green text-white font-semibold text-sm hover:-translate-y-0.5 transition-all shadow-lg shadow-forest-green/20'
                    >
                        Generate Link
                    </button>
                )}
